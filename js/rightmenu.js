...
rmf.copySelect = function(){
    document.execCommand('复制成功啦！！！',false,null);
    //这里可以写点东西提示一下 已复制
}
...
rmf.switchLanguageMode = function translatePage() {
...
// 新窗口打开链接
rmf.openLinkInNewWindow = function(){
    // 先检测是否有选中的链接，再打开新窗口
    var hoveredElement = document.querySelector(':hover');
    if (hoveredElement && hoveredElement.tagName === 'A') {
        var link = hoveredElement.href;
